...
return [
    ...
    'received_password_reset_request' => 'أنت تتلقى هذا البريد لأننا استلمنا طلبًا لإعادة تعيين كلمة المرور لحسابك.',
    'reset_password' => 'إعادة تعيين كلمة المرور',
    'password_reset_link_expire' => 'سينتهي رابط إعادة تعيين كلمة المرور خلال :count دقيقة.',
    'no_further_action_required' => 'إذا لم تطلب إعادة تعيين كلمة المرور، فلا حاجة لاتخاذ أي إجراء.',
    'all-rights-reserved' => 'جميع الحقوق محفوظة.',
    'all-copy-right-reserved-by-discover-jordan' => 'جميع الحقوق محفوظة لـ اكتشف الأردن.',
    'reset_password_title' => 'اكتشف الأردن | إعادة تعيين كلمة المرور',
    'reset_password_description' => 'يرجى تعبئة الحقول التالية لإعادة تعيين كلمة المرور.',
