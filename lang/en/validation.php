...
return [
    ...
    */
    ...
    'api' => [
        ...
        'activity-end-time-after-start' => 'The activity end time must be after the start time.',
        'activity-start-time-sequence' => 'The activity start times must be in sequential order.',
        ...
        'check_if_followers_existence' => 'The user :user is not a follower.',
        ...
        'tag_does_not_exist' => 'The specified tag does not exist.',
