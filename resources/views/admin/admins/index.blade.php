                                    ...
                                    <tbody>
                                        @foreach ($admins as $key => $admin)
                                            <tr style="text-align: center">
                                                ...
                                                <td class="text-center col-2"><img src="{{ $admin['image'] != null ? asset($admin['image']) : asset('assets/images/avatar.png') }}"
                                                        alt="{{ $admin['image'] != null ? $admin['name'] : 'avatar' }}" width="50px" height="50px">
                                                </td>
                                                ...
                                                <td class="text-center col-2">
                                                    ...
                                                    <a class="btn btn-outline-warning btn-sm edit" title="Edit" href="{{ route('admin.admins.edit', $admin['id']) }}">
