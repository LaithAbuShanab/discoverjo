    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('layouts.admin.title', ['title' => __('app.features')])
                <!-- end page title -->
                                    ...
                                    <tbody>
                                        @foreach ($features as $key => $feature)
                                            <tr>
                                                ...
                                                <td class="text-center col-2"><img src="{{ $feature['image_active'] != null ? asset($feature['image_active']) : asset('assets/images/category.jpg') }}"
                                                        alt="{{ $feature['image_active'] != null ? $feature['name'] : 'avatar' }}" width="50px" height="50px">
                                                </td>
                                                <td class="text-center col-2">
                                                    {{--                                                    @if (AdminPermission('edit feature')) --}}
                                                    <a class="btn btn-outline-warning btn-sm edit" title="Edit" href="{{ route('admin.features.edit', $feature['id']) }}">
                                                        <i class="fas fa-pencil-alt" title="Edit"></i>
                                                    </a>
                                                    {{--                                                    @endif --}}
                                                    {{--                                                    @if (AdminPermission('delete feature')) --}}
                                                    <form method="post" action="{{ route('admin.features.destroy', $feature['id']) }}" style="display:inline;">
                                                        @csrf
                                                        @method('delete')
