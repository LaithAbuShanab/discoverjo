    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('layouts.admin.title', ['title' => __('app.place.edit-place')])
                <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.places.update', $place['id']) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('app.place-en') }}" name="name_en" value="{{ old('name_en', $place['name_en']) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('app.place-ar') }}" name="name_ar" value="{{ old('name_ar', $place['name_ar']) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_en" class="form-control" rows="3" id="validationTooltip03" placeholder="{{ __('app.description-enter-en') }}">{{ old('description_en', $place['description_en']) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationTooltip04">{{ __('app.description-ar') }}</label>
                                            <textarea name="description_ar" class="form-control" rows="3" id="validationTooltip04" placeholder="{{ __('app.description-enter-ar') }}">{{ old('description_ar', $place['description_ar']) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('app.address-enter-en') }}" name="address_en"
                                                value="{{ old('address_en', $place['address_en']) }}" id="validationTooltip05">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationTooltip06">{{ __('app.address-ar') }}</label>
                                            <input type="text" class="form-control" placeholder="{{ __('app.address-enter-ar') }}" name="address_ar"
                                                value="{{ old('address_ar', $place['address_ar']) }}" id="validationTooltip06">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control" placeholder="{{ __('app.google-map-url-enter') }}" name="google_map_url"
                                                value="{{ old('google_map_url', $place['google_map_url']) }}" id="validationTooltip07">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationTooltip08">{{ __('app.phone-number') }}</label>
                                            <input type="text" class="form-control" placeholder="{{ __('app.phone-number-enter') }}" name="phone_number"
                                                value="{{ old('phone_number', $place['phone_number']) }}" id="validationTooltip08">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="{{ __('app.longitude-enter') }}" name="longitude"
                                                value="{{ old('longitude', $place['longitude']) }}" id="validationTooltip09" step="0.0000001">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationTooltip10">{{ __('app.latitude') }}</label>
                                            <input type="number" class="form-control" placeholder="{{ __('app.latitude-enter') }}" name="latitude" value="{{ old('latitude', $place['latitude']) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="{{ __('app.price-level-enter') }}" name="price_level"
                                                value="{{ old('price_level', $place['price_level']) }}" id="validationTooltip11" max="4" min="-1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="validationTooltip12">{{ __('app.website') }}</label>
                                            <input type="url" class="form-control" placeholder="{{ __('app.website-enter') }}" name="website" value="{{ old('website', $place['website']) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="{{ __('app.rating-enter') }}" name="rating" value="{{ old('rating', $place['rating']) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="{{ __('app.total-user-rating-enter') }}" name="total_user_rating"
                                                value="{{ old('total_user_rating', $place['total_user_rating']) }}" id="validationTooltip14" min="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2-multiple" name="sub_category_id[]" id="validationTooltip15" multiple data-placeholder="{{ __('app.choose...') }}"
                                                required>
                                                <option value="">{{ __('app.select-one') }}</option>
                                                @foreach ($subCategories as $subCategory)
                                                    <option value="{{ $subCategory->id }}" @if (in_array($subCategory->id, array_column($place['sub_category'], 'id'))) selected @endif>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="region_id" id="validationTooltip16">
                                                ...
                                                @foreach ($regions as $region)
                                                    <option value="{{ $region['id'] }}" @if ($region['name'] == $place['region']) selected @endif>
                                                        {{ $region['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="business_status" id="validationTooltip17">
                                                <option value="">{{ __('app.select-one') }}</option>
                                                <option value=1 @if ($place['business_status'] == 'Operational' || $place['business_status'] == 'شغال') selected @endif>
                                                    {{ __('app.operational') }}</option>
                                                <option value=0 @if ($place['business_status'] == 'Closed' || $place['business_status'] == 'مغلق') selected @endif>
                                                    {{ __('app.closed') }}</option>
                                                <option value=2 @if ($place['business_status'] == 'Temporary Closed' || $place['business_status'] == 'مغلق مؤقتا') selected @endif>
                                                    {{ __('app.temporary_closed') }}</option>
                                                <option value=3 @if ($place['business_status'] == 'We don\'t have any information about that' || $place['business_status'] == 'ليس لدينا معلومة عن ذلك') selected @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-control select2-multiple" name="tags_id[]" multiple data-placeholder="{{ __('app.choose...') }}" id="validationTooltip18">
                                                <option value="">{{ __('app.select-one') }}</option>
                                                @foreach ($tags as $tag)
                                                    <option value="{{ $tag['id'] }}" @if (in_array($tag['id'], array_column($place['tags'], 'id'))) selected @endif>
                                                        {{ $tag['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                @forelse ($place['opening_hours'] as $key => $opening)
                                    <div class="row" id="{{ $key != 0 ? 'remove' . $key : '' }}">
                                        <input type="hidden" id="count" value="{{ count($place['opening_hours']) - 1 }}">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="day_of_week{{ $key }}">{{ __('app.day-of-week') }}</label>
                                                <select class="select2 form-control select2-multiple" name="day_of_week[{{ $key }}][]" id="day_of_week{{ $key }}" multiple
                                                    data-placeholder="{{ __('app.choose...') }}" onchange="check({{ $key }})">
                                                    <option value="Monday" {{ in_array('Monday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.monday') }}</option>
                                                    <option value="Tuesday" {{ in_array('Tuesday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.tuesday') }}</option>
                                                    <option value="Wednesday" {{ in_array('Wednesday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.wednesday') }}</option>
                                                    <option value="Thursday" {{ in_array('Thursday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.thursday') }}</option>
                                                    <option value="Friday" {{ in_array('Friday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.friday') }}</option>
                                                    <option value="Saturday" {{ in_array('Saturday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                                        {{ __('app.saturday') }}</option>
                                                    <option value="Sunday" {{ in_array('Sunday', array_column($opening, 'day_of_week')) ? 'selected' : '' }}>
                                        ...
                                        <div id="timeDiv{{ $key }}" class="row col-md-6">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="time" class="form-control" name="opening_hours[]" value="{{ $opening[0]['opening_time'] }}" id="opening_time{{ $key }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="closing_time">{{ __('app.closing-time') }}</label>
                                                    <input type="time" class="form-control" name="closing_hours[]" value="{{ $opening[0]['closing_time'] }}" id="closing_time{{ $key }}">
                                                </div>
                                            </div>
                                            @if ($key == 0)
                                                <div class="col-md-4">
                                            ...
                                            @else
                                                <div class="col-md-4">
                                                    <div class="mb-3 text-center">
                                                        ...
                                                        <button class="icon-button" onclick="remove({{ $key }})" style="background: none; border: none; padding: 0; cursor: pointer;"
                                                            type="button">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="feature{{ $key }}" value="{{ $feature['id'] }}" name="feature_id[]"
                                                    @if (in_array($feature['id'], array_column($place['features'], 'id'))) checked @endif>
                            ...
                            <div id="oldGalleryPreview" class="row">
                                @foreach ($place['gallery'] as $image)
                                    <div class="col-md-3 mb-3">
                                        <div class="card">
                                            <img src="{{ $image['url'] }}" class="card-img-top" id = "{{ $image['id'] }}" alt="Gallery Image"
