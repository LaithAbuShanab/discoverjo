    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('layouts.admin.title', ['title' => __('app.edit-slider')])
                <!-- end page title -->
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.sliders.update', $slider['id']) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="{{ __('app.title-en') }}" name="title_en"
                                                   value="{{ old('title_en', $slider['title_en']) }}" id="title_en" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="{{ __('app.title-ar') }}" name="title_ar"
                                                   value="{{ old('title_ar', $slider['title_ar']) }}" id="title_ar" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="{{ __('app.content-en') }}" name="content_en"
                                                   value="{{ old('content_en', $slider['content_en']) }}" id="content_en" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="{{ __('app.content-ar') }}" name="content_ar"
                                                   value="{{ old('content_ar', $slider['content_ar']) }}" id="content_ar" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="type" id="type">
                                                ...
                                                <option value="onboarding" @if($slider['type'] == 'onboarding')selected @endif>{{ __('app.onboarding') }}</option>
                                                <option value="banner" @if($slider['type'] == 'banner')selected @endif>{{ __('app.banner') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status" id="status-slider">
                                                <option value="">{{ __('app.select-one') }}</option>
                                                <option value=1 @if($slider['status'] == 1)selected @endif>{{ __('app.active') }}</option>
                                                <option value=0 @if($slider['status'] == 0)selected @endif>{{ __('app.inactive') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="priority"
                                                ...
                                                value="{{ old('priority', $slider['priority']) }}" required
                                                min="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <img src="{{ $slider['image'] != null ? asset($slider['image']) : asset('slider.jpg') }}"
                                                alt="{{ $slider['image'] != null ? $slider['title'] : 'avatar' }}"
