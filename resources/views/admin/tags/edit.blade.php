                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.tags.update', $tag['id']) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('app.tag-en') }}" id="name_en" name="name_en" value="{{ old('name_en', $tag['name_en']) }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('app.tag-ar') }}" id="name_ar" name="name_ar" value="{{ old('name_ar', $tag['name_ar']) }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <img src="{{ $tag['image_active'] != null ? asset($tag['image_active']) : asset('assets/images/category.jpg') }}"
                                                alt="{{ $tag['image_active'] != null ? $tag['image_active'] : 'avatar' }}" id="previewImage" style="width: 100px; height: 100px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top: 33px;">
                                        <div class="mb-3">
                                            <img src="{{ $tag['image_inactive'] != null ? asset($tag['image_inactive']) : asset('assets/images/category.jpg') }}"
                                                alt="{{ $tag['image_inactive'] != null ? $tag['image_inactive'] : 'avatar' }}" id="previewImage2" style="width: 100px; height: 100px;">
                                        </div>
                                    </div>
                                </div>
