                                    ...
                                    <tbody>
                                        @foreach ($tags as $key => $tag)
                                            <tr>
                                                ...
                                                <td class="text-center col-2"><img src="{{ $tag['image_active'] != null ? asset($tag['image_active']) : asset('assets/images/category.jpg') }}"
                                                        alt="{{ $tag['image_active'] != null ? $tag['name'] : 'avatar' }}" width="50px" height="50px">
                                                </td>
                                                <td class="text-center col-2">
                                                    {{--                                                    @if (AdminPermission('edit tag')) --}}
                                                    <a class="btn btn-outline-warning btn-sm edit" title="Edit" href="{{ route('admin.tags.edit', $tag['id']) }}">
