<form wire:submit.prevent="submit">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control"
                       placeholder="{{ __('app.legal.title_en') }}" wire:model="title_en"
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control"
                       placeholder="{{ __('app.legal.title_ar') }}" wire:model="title_ar"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div>
                    <textarea required wire:model="content_en" class="form-control" rows="3" id="validationTooltip03" placeholder="{{ __('app.legal.content-enter-en') }}">{{ old('content_en') }}</textarea>
                    @error('content_en')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div>
                    <textarea required wire:model="content_ar" class="form-control" rows="3" id="validationTooltip04" placeholder="{{ __('app.legal.content-enter-ar') }}">{{ old('content_ar') }}</textarea>
                    @error('content_ar')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label" for="validationTooltip17">{{ __('app.type') }}</label>
